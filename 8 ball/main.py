...
pygame.display.set_caption("lion of kurdistan - Pool Game")
...
t_image = pygame.image.load('images/table.png').convert_alpha()
balls_imgs = []
for imo in range(1,17):
    ball_img = pygame.image.load(f'images/ball_{imo}.png').convert_alpha()
